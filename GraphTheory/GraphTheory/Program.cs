            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        var g = graph.AlgorithmByPrim();
                        if (g != null)
                        {
                            Print(g);
                            Console.WriteLine($"Вес остовного дерева: {g.GetWeightOfGraph()}");
                        }
                        break;
                    case 12:
                        Console.Write("Введите имя вершины \"откуда\": ");
                        graph.IVa(new Vertex(Console.ReadLine()));
                        break;
                    case 13:
                        graph.IVb();
                        break;
                    case 14:
                        Console.Write("Введите имя вершины \"куда\": ");
                        graph.IVc(new Vertex(Console.ReadLine()));
                        break;
                    case 15:
                        do
                        {
